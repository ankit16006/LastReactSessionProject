...
import taj from '../asset/taj2.png'
...
function Tajmahal() {
  return (
    ...
    <div className='thead'><b>Tajmahal</b></div>
    <img src={taj} ></img>
<div className='text'>
  <span >  Who could ever think that an eternal love leading to the saga of infinite bondage can evolve out of a desert like land and would blossom to be the reason to gift our world a poem-in-marble, The Taj!
...
<span style={{paddingTop:"20px"}}><br></br>
