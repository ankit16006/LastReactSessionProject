...
function RedFort() {
  return (
    <div>
        <div><h2>Red Fort</h2></div>
        <div>
        The fort’s massive red sandstone walls, which stand 75 feet (23 metres) high, 
        ...
        The Red Fort was built by none other than the Mughal Emperor Shah Jahan to serve as the palace fort for his 
...
The Red Fort underwent massive destruction in 1739 when the Persian ruler Nadir Shan invaded 
