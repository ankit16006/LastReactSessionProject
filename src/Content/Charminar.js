...
function Charminar() {
  return (
    <div>
        ...
        <div>
        Dubbed the Arc de Triomphe of the east and Hyderabad’s most iconic structure, Charminar, 
        ...
        bangle sellers and food stalls.

The Charminar was built in 1591 after Muhammad Quli Qutb Shah, the fifth king of the Qutb Shahi dynasty, moved his 
...
Islam’s second millennium year 1000 AH as the reason for the construction of the Charminar in 1591.

It is no surprise that the old city of Hyderabad came up around the Charminar, and its strategic positioning at 
the intersection of historical trade routes that connects the port city of Machilipatnam with the markets of Golconda.

Built in Indo-Islamic architectural style, Charminar is a limestone, granite, pulverised marble and mortar structure with 
...
the Taj Mahal’s are attached to the superstructure.

Not just Charminar’s strategic positioning or its significance in the history of Hyderabad, the structure still 
...
an escape route in case of a siege. Though the location of the tunnel has not been ascertained till date.
...
stone balcony. The open space in the main gallery is meant for the Friday prayers.
